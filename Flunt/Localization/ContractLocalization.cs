namespace Flunt.Localization
{
    public static class ContractLocalization
    {
        ...
        public static string IsFalseErrorMessage(string key) => $"{key} should not be false";
        public static string IsTrueErrorMessage(string key) => $"{key} should not be true";
        ...
        public static string IsLowerThanErrorMessage(string key, string comparer) => $"{key} should be greater than {comparer}";
        public static string IsLowerOrEqualsThanErrorMessage(string key, string comparer) => $"{key} should be greater or equals than {comparer}";
